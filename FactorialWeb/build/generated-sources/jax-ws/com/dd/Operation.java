 ...
 * 
 */
@WebServiceClient(name = "Operation", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:44370/Operation.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:44370/Operation.asmx?WSDL");
